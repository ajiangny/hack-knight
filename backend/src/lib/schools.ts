// MLH's verified school list (schools.csv from github.com/MLH/mlh-policies),
// generated by a script — do not hand-edit; regenerate from a fresh CSV.
// List dated 2026-08-09.
//
// KEEP IN SYNC with frontend/src/lib/schools.ts — the registration form's
// combobox offers that copy; this copy is the allowlist the API enforces, so
// the two must come from the same CSV.
...
const SCHOOL_SET: ReadonlySet<string> = new Set(SCHOOLS);

export function isValidSchool(value: string): boolean {
